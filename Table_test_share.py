...
class Data_Speed_Window(object):
    def setupUi(self, Form):
        ...
        Form.resize(630, 437)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("wifi_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def itemset_header(self, Form):
        ...
        self.loaddata()                                          # Load the data to table widget
        self.pushButtonsearch.clicked.connect(self.Tosearch)     # Search the item
        self.selectsubmitbutton.clicked.connect(self.Tosort)     # Sort the column
    ...
    def Tosearch(self):
        ...
        :return: Highlighted the current text in table widget from lineedit box
        """
